  ...
  return (
    <Toolbar>
      <Typography className={classes.title} variant="h6" id="tableTitle">
        Zahtevi za pronalazenje sale za preglede
      </Typography>
        ...
        <Paper className={classes.paper}>
          ...
          <div className={classes.tableWrapper}>
            ...
            >
              ...
              <TableBody>
                {pregledi &&
                  stableSort(pregledi, getSorting(order, orderBy))
                ...
                {rowsPerPage -
                  Math.min(rowsPerPage, pregledi.length - page * rowsPerPage) >
                  0 && (
                  <TableRow
                    style={{
                      height:
                        ...
                        (rowsPerPage -
                          Math.min(
                            rowsPerPage,
                            pregledi.length - page * rowsPerPage
                          ))
                    }}
                  >
                    <TableCell colSpan={6} />
...
const mapStateToProps = state => ({
  ...
  pregledi: state.pregled.preglediPronalazenjeSale
});
